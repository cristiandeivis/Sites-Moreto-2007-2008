...
<p align="justify" class="unnamed1"><img src="../selecaologo.gif" width="623" height="68"></p>
<blockquote> 
  <form name="form1" method="post" action="">
	...
	?>
    <table width="67%" border="1" cellpadding="1" cellspacing="1" bordercolor="#6699CC">
      <tr> 
        <td width="4%"><font color="#000000"><?=$linha->codigo?>&nbsp; </font> </td>
